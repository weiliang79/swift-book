                    ...
                    <div class="row">
                        ...
                        <ul class="col-6 list-group d-flex justtify-content-center">
                            <li class="list-group-item d-flex flex-column" >
                                ...
                                <button id="addToCartBtn" type="button" class="btn btn-primary btn-lg col-12" onclick="addToCartClickedDetailPage('{{ route('cart.add', ['book_id' => $book->id]) }}');" {{ auth()->user()->carts()->where('book_id', $book->id)->count() !== 0 ? 'disabled' : '' }}>Add to Cart</button>
                            </li>
