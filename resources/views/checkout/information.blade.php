    ...
    <div class="container" style="max-width: 1000px">
        <div class="row" style="font-family: 'Segoe UI'; font-size: 1rem">
            <div class="col-lg-7">
                ...
                <form class="needs-validation" method="post" action="{{ url("/checkout/{$order->id}") }}">
                    @csrf
                    <div class="row g-3">
                        <div class="col-sm-6">
                        ...
                        <div class="col-12">
                            ...
                            <input class="form-control {{ $errors->has('address') ? ' is-invalid' : '' }}" name="address"
                                type="text" placeholder="117 Lebuh Relau 9, Sungai Ara" value="{{ old('address') }}"
                                required>
                            @error('address')
                                <div class="invalid-feedback">
                                    {{ $message }}
                        ...
                        <div class="col-12">
                            ...
                            <input class="form-control {{ $errors->has('address2') ? ' is-invalid' : '' }}" name="address2"
                                type="text" placeholder="Apartment, Condominium, etc">
                            @error('address2')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <input class="form-control {{ $errors->has('town') ? ' is-invalid' : '' }}" name="town"
                                type="text" placeholder="Georgetown" value="{{ old('town') }}" required>
                            @error('town')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="col-md-3">
                            ...
                            <input class="form-control {{ $errors->has('postcode') ? ' is-invalid' : '' }}" name="postcode"
                                type="number" placeholder="11900" value="{{ old('postcode') }}" required>
                            @error('postcode')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="col-12">
                            ...
                            <input class="form-control {{ $errors->has('phoneNumber') ? ' is-invalid' : '' }}"
                                name="phoneNumber" type="tel" value="{{ old('phoneNumber') }}" required>
                            @error('phoneNumber')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                ...
                @foreach ($carts as $cart)
                    <div class="d-flex my-2 mb-3 justify-content-between align-items-center">
                        <div style="width: 4.6rem; height: 4.6rem;">
                            <img class="w-100 h-100" src="{{ asset('storage/' . $cart->book->image_path) }}"
                                style="object-fit: contain; border: 1px rgb(190, 190, 190) solid; border-radius: 5px">
                        </div>
